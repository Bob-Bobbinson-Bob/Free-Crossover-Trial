# Disclaimer #
This software is for EEDUCATIONAL PURPOSES ONLY!!!! Please support the official release of Crossover
...
2. Runn this code, changing the path/to/ bit to wherever you put your python file:
```python3
python3 path/to/update_first_run.py
```

3. You're done! Easy as that! Enjoy!
